...
public class StringProgramFrom19 {
	...
	public static void main(String[] args) {
        ...
        String str4 = "Java Exercises";
        String str5 = new StringBuffer("Java").append(" Exercises").toString();
        ...
        System.out.println("str1 == str3? " + (str4 == str6));
